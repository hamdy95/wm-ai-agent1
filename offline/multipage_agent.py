...
class MultiPageSiteGenerator:
    ...
    def add_page_to_template(self, channel: ET.Element, page_type: str, page_data: Dict[str, Any], page_id: int) -> None:
    ...
    def create_multi_page_site(self, user_query: str, output_path: str) -> str:
        ...
        for page_type in page_types:
            if page_type in selected_pages:
                self.add_page_to_template(channel, page_type, selected_pages[page_type], page_id)
                page_id += 1
